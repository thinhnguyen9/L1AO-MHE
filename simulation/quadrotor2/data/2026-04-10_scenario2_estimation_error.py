...
DEFAULT_LABEL_MAP = {
    "MHE (baseline N=10)": "MHE ($N=10$, CVXOPT)",
    "MHE (baseline N=20)": "MHE ($N=20$, CVXOPT)",
    "MHE (baseline N=40)": "MHE ($N=40$, CVXOPT)",
...
DEFAULT_COLORS = {
    ...
    "MHE (baseline N=10)": "tab:blue", 
    "MHE (baseline N=40)": "blue",
    "MHE (PCIP N=10)": "tab:orange", 
...
DEFAULT_LINES = {
    ...
    "MHE (baseline N=10)": "solid", 
    "MHE (baseline N=40)": "solid",
    "MHE (PCIP N=10)": "solid", 
    "MHE (PCIP N=40)": "solid",
...
DEFAULT_LINEWEIGHT = {
    ...
    "MHE (baseline N=10)"     : 1.5, 
    "MHE (baseline N=40)"     : 1.5,
    "MHE (PCIP N=10)"         : 1.5, 
    "MHE (PCIP N=40)"         : 1.5,
...
def plot_csv(
    ...
    if handles:
        ...
        leg = ax.legend(by_label.values(), by_label.keys(), loc='lower right', fontsize=9)
        try:
...
def main():
    ...
    plot_csv(
        csv_path=csv_path,
        run_id_filter=["52f3cac1", "c0daa490"],
        # estimators_filter=[
        #     "EKF", 
        #     "MHE (OSQP N=10)", 
